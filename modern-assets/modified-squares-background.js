...
class SquaresBackground {
  ...
  init() {
    ...
    if (!container) {
      console.error(`No element with selector ${this.options.selector} found`);
      return;
    }
...
document.addEventListener('DOMContentLoaded', function() {
  // We're not initializing the hero section background here
  // This is intentionally left empty to remove the grid effect from the carousel
});
